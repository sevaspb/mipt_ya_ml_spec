...
display(Markdown("Итог: при увеличении n становится всё более нагляна центральная предельная теорема. График плотности нормально распределения, постороенный на статистиках исходного распределения Парето, при увеличении n, лучше аппроксимирует гистограмму, построенную по выборочному среднему."))
